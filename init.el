...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jedi vue-mode dtrt-indent neotree hungry-delete ac-php smartparens ace-window tabbar flycheck virtualenvwrapper helm magit psvn diff-hl elscreen multiple-cursors evil spacemacs-theme solarized-theme)))
